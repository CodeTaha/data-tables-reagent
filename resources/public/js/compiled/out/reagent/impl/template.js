...
var or__4563__auto__ = reagent.impl.template.named_QMARK_(x);
...
var or__4563__auto__ = reagent.impl.template.hiccup_tag_QMARK_(x);
if(cljs.core.truth_(or__4563__auto__)){
return or__4563__auto__;
} else {
...
var G__7771 = o;
(G__7771[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_7775 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_7775))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_7775)].join(''):class$));
} else {
}
...
if(cljs.core.not((function (){var and__4551__auto__ = (node === document.activeElement);
if(and__4551__auto__){
var and__4551__auto____$1 = reagent.impl.template.has_selection_api_QMARK_((node["type"]));
...
var G__7778 = jsprops;
(G__7778["defaultValue"] = value);

(G__7778["onChange"] = ((function (G__7778,v,value,on_change){
return (function (p1__7776_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__7776_SHARP_);
});})(G__7778,v,value,on_change))
);
...
var vec__7780 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7780,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7780,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7780,(2),null);
...
var temp__4427__auto__ = (function (){var G__7784 = cljs.core.meta(v);
var G__7784__$1 = (((G__7784 == null))?null:reagent.impl.template.get_key(G__7784));
return G__7784__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__7786_7787 = v;
var G__7786_7788__$1 = (((G__7786_7787 == null))?null:reagent.impl.template.key_from_vec(G__7786_7787));
var G__7786_7789__$2 = (((G__7786_7788__$1 == null))?null:(jsprops["key"] = G__7786_7788__$1));
...
var G__7793 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__7793) : reagent.impl.template.as_element.call(null,G__7793));
} else {
var p = (function (){var temp__4427__auto__ = (function (){var G__7794 = cljs.core.meta(argv);
var G__7794__$1 = (((G__7794 == null))?null:reagent.impl.template.get_key(G__7794));
return G__7794__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__7795 = (((jsprops == null))?{}:jsprops);
(G__7795["key"] = key);
...
var G__7796 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__7796;
continue;
}
} else {
...
var n__5466__auto___7797 = a.length;
var i_7798 = (0);
while(true){
if((i_7798 < n__5466__auto___7797)){
(a[i_7798] = reagent.impl.template.as_element((a[i_7798])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__5466__auto___7800 = a.length;
var i_7801 = (0);
while(true){
if((i_7801 < n__5466__auto___7800)){
var val_7802 = (a[i_7801]);
if((cljs.core.vector_QMARK_(val_7802)) && ((reagent.impl.template.key_from_vec(val_7802) == null))){
(o["no-key"] = true);
} else {
}

(a[i_7801] = reagent.impl.template.as_element(val_7802));
...
if(cljs.core.truth_((function (){var and__4551__auto__ = cljs.core.not(reagent.impl.component._STAR_non_reactive_STAR_);
if(and__4551__auto__){
return (ctx["no-key"]);
} else {
return and__4551__auto__;
...
var G__7805 = (cljs.core.count(argv) - first_child);
switch (G__7805) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__7805){
